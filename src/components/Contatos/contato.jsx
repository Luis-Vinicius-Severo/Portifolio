        ...
        <div className={styles.conteudoContato}>
          ...
          <div className={styles.colunaInformacoes}>
            ...
            <div className={styles.infoItem}>
              ...
              <a href="mailto:luislucasinter13@hotmail.com" className={styles.valorInfo}>
            ...
            <div className={styles.infoItem}>
              ...
              <span className={styles.valorInfo}>Rio Grande do Sul, Brasil</span>
            </div>

            <div className={styles.redesSociais}>
              <strong className={styles.rotuloInfo}>Redes Sociais</strong>
              <div className={styles.linksRedes}>
                <a href="https://github.com/Luis-Vinicius-Severo" target="_blank" rel="noopener noreferrer" className={styles.linkRede}>
                  GitHub
                </a>
                <a href="https://www.linkedin.com/in/luisviniciussevero" target="_blank" rel="noopener noreferrer" className={styles.linkRede}>
                  LinkedIn
                </a>
                <a href="https://www.instagram.com/z_luisvinicius" target="_blank" rel="noopener noreferrer" className={styles.linkRede}>
                  Instagram
                </a>
              </div>
            </div>
