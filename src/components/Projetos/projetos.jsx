...
const Projetos = () => {
  const projetos = [
    {
      titulo: "BikCraft",
      descricao: "Site completo para uma loja de bicicletas artesanais, com catálogo de produtos e informações da empresa.",
      imagem: "../src/assets/projeto-bikcraft.jpeg",
    ...
    {
      titulo: "Hamburgueria",
      descricao: "Site para hamburgueria com cardápio interativo e design moderno para melhor experiência do usuário.",
      imagem: "../src/assets/projeto-hamburguer.png",
      tecnologias: ["JavaScript", "HTML5", "CSS3"],
    ...
    },
    {
      ...
      descricao: "Sistema de informações geográficas para visualização e consulta de dados de localização.",
      imagem: "../src/assets/projeto-informacoes.jpeg",
      tecnologias: ["JavaScript", "HTML5", "CSS3"],
              ...
              <div className={styles.imagemProjeto}>
                ...
                <div className={styles.overlayProjeto}>
                  <div className={styles.linksProjeto}>
                    <a href={projeto.demo} target="_blank" rel="noopener noreferrer" className={styles.linkDemo}>
                      Demo
                    </a>
                    <a href={projeto.github} target="_blank" rel="noopener noreferrer" className={styles.linkGitHub}>
                      GitHub
                    </a>
                  </div>
                </div>
              ...
              <div className={styles.infoProjeto}>
                ...
                <div className={styles.tecnologiasProjeto}>
                  {projeto.tecnologias.map((tech, techIndex) => (
                    <span key={techIndex} className={styles.tagTecnologia}>{tech}</span>
                  ))}
                </div>
              </div>
            </div>
